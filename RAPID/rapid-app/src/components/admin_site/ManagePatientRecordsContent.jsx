...
function ManagePatientRecordsContent() {
    ...
    const fetchAccountInformation = async (accountId) => {
        try {
            ...
            if (!querySnapshot.empty) {
                ...
                console.log("No matching documents found for accountId:", accountId);
                return "N/A";
            }
        } catch (error) {
    ...
    const fetchArpNames = async (records) => {
        console.log("Fetching ARP names for records:", records); // Debug log
        const namesMap = {};
                                            ...
                                            <div className="col-xxl-12 col-md-12">
                                                <div className="card shadow border-0 mb-7">
                                                    <div className="card-header">
                                                        <h5 className="mb-0">List of Patient Care Reports</h5>
                                                    </div>
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="row">
                                        ...
                                        {modalRemarks == "View" &&
                                            <>
                                                <div className="col-md-2">
                                                    <label style={{ color: 'black', marginBottom: '10px' }} htmlFor="ambulanceInput">Patient Report Status:  </label>
                                                </div>

                                                <div className="col-md-10">
                                                    <label style={{ color: 'black', marginBottom: '10px' }} htmlFor="ambulanceInput"><b>{viewPatientStatus} </b></label>
                                                </div>
                                        ...
                                        {modalRemarks == "Edit" &&
                                            <>
                                                <div className="col-md-12">
                                                    <p style={{ color: 'black', marginTop: '10px' }} htmlFor="ambulanceInput"><i>Note: You can update the status of the report by selecting one of the following options.  </i> </p><br></br>
                                                </div>

                                                <div className="col-md-12 d-flex justify-content-start align-items-start" >
                                                    <label style={{ color: 'black', marginBottom: '10px' }} htmlFor="ambulanceInput">Select Report Status:   </label>
                                                </div>

                                                <div className="col-md-12 d-flex justify-content-start align-items-start">
                                                    <button className="btn btn-success btn-sm" style={{ marginRight: '10px' }}
                                                        type="button"
                                                        onClick={() => { UpdatePatientStatus(editPatientID, "Completed") }}>
                                                        <i className="fa fa-check"></i> Completed
                                                    </button>

                                                    <button className="btn btn-primary btn-sm" style={{ marginRight: '10px' }}
                                                        type="button"
                                                        onClick={() => { UpdatePatientStatus(editPatientID, "Active") }}>
                                                        <i className="fa fa-circle"></i> Active
                                                    </button>

                                                    <button className="btn btn-danger btn-sm" style={{ marginRight: '10px' }}
                                                        type="button"
                                                        onClick={() => { UpdatePatientStatus(editPatientID, "Did Not Arrive") }}>
