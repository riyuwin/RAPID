                                                ...
                                                <table className="table datatable table-custom">
                                                    ...
                                                    <tbody>
                                                        {patient_loading ? (
                                                            ...
                                                            filteredAccounts.map((patient, index) => (
                                                                <tr key={patient.id}>
                                                                    <td>{index + 1}</td>
                                                                    <td>
                                                                        {`${patient.basicInformation?.firstName || "Unknown"} ${patient.basicInformation?.surname || ""
                                                                            }`.trim()}
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <button className="btn btn-success btn-sm"
                                                                            data-bs-toggle="modal" data-bs-target="#addPatientCareReport"
